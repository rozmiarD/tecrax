...
[![Package: tecrax 0.3.17a0](https://img.shields.io/badge/package-tecrax%200.3.17a0-blueviolet.svg)](https://pypi.org/project/tecrax/0.3.17a0/)
...
[![Dependency: RExecOp ==0.2.22a0](https://img.shields.io/badge/dependency-RExecOp%20%3D%3D0.2.22a0-informational.svg)](https://github.com/rozmiarD/RExecOP)
...
| Item | Value |
| --- | --- |
| Current source line | `0.3.17a0` (`0.3.17-alpha`) |
| Maturity | **alpha** — operator evaluation with documented limits |
| Latest PyPI | [`tecrax==0.3.17a0`](https://pypi.org/project/tecrax/0.3.17a0/) |
| Source dependencies | `govengine==0.16.9`, `sclite-core==1.0.8`, `rexecop==0.2.22a0` |
...
```bash
pip install "rexecop[tecrax]==0.2.22a0"
```
...
`0.2.22a0`, GovEngine `0.16.9`, and SCLite `1.0.8`. It does not add a second
