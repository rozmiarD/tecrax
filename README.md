...
| Network devices | [`network-device-readonly-runbook.md`](docs/runbooks/network-device-readonly-runbook.md), [`network-device-time-alignment-runbook.md`](docs/runbooks/network-device-time-alignment-runbook.md), [`network-security-device-syslog-to-wazuh-runbook.md`](docs/runbooks/network-security-device-syslog-to-wazuh-runbook.md) |
