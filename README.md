...
[![Dependency: SCLite ==1.1.0rc1](https://img.shields.io/badge/dependency-SCLite%20%3D%3D1.1.0rc1-informational.svg)](https://github.com/rozmiarD/SCLite)
...
| Source dependencies | `govengine==0.16.12rc1`, `sclite-core==1.1.0rc1`, `rexecop==0.2.25a0` |
...
`0.2.25a0`, GovEngine `0.16.12rc1`, and SCLite `1.1.0rc1`. It does not add a second
